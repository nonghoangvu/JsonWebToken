...
INSERT INTO tbl_user (last_name,first_name,date_of_birth,gender,phone,email,username,"password",status,"type",created_at,updated_at) VALUES
	 ('Dang Thanh','Tung','1989-05-06','MALE','0123456789','someone@email.com','user8','password','ACTIVE','USER','2024-04-18 09:56:29.231','2024-04-18 09:56:29.231'),
	 ('Nguyen Khac','Trung','1990-06-07','MALE','0123456789','someone@email.com','user9','password','ACTIVE','USER','2024-04-18 09:56:30.136','2024-04-18 09:56:30.136'),
	 ('Truong Hai','Kien','1991-07-09','MALE','0123456789','someone@email.com','user10','password','ACTIVE','USER','2024-04-18 09:56:30.6','2024-04-18 09:56:30.6'),
	 ('Vu Hong','Quan','1992-08-11','MALE','0123456789','someone@email.com','user11','password','ACTIVE','USER','2024-04-18 09:56:30.963','2024-04-18 09:56:30.963'),
	 ('Nguyen Trung','Nguyen','2003-03-12','MALE','0123456789','someone@email.com','user21','password','ACTIVE','USER','2024-04-18 09:56:22.366','2024-04-18 09:56:22.366'),
	 ('Java','Tây','2003-06-05','MALE','0123456789','someone@email.com','user22','password','ACTIVE','USER','2024-04-20 06:00:46.115','2024-04-20 06:00:46.115'),
	 ('Dang','Huy','2001-04-23','MALE','0123456789','someone@email.com','user23','password','INACTIVE','USER','2024-04-18 09:56:23.573','2024-04-18 09:56:23.573'),
	 ('Minh','Khang','2002-05-25','MALE','0123456789','someone@email.com','user24','password','NONE','USER','2024-04-18 09:56:24.091','2024-04-18 09:56:24.091'),
	 ('Le','Ngan','2004-02-15','MALE','0123456789','someone@email.com','user25','password','ACTIVE','USER','2024-04-18 09:56:21.536','2024-04-18 09:56:21.536'),
	 ('Thuy','Thuy','2003-05-20','FEMALE','0123456789','someone@email.com','user26','password','ACTIVE','USER','2024-04-18 09:56:23.06','2024-04-18 09:56:23.06'),
	 ('Sys','SysAdmin','1980-06-05','MALE','0123456789','sysadmin@email.com','sysadmin','password','ACTIVE','OWNER','2024-04-18 09:58:07.169','2024-04-18 09:58:07.169'),
	 ('Tran Ngoc','Tu','1993-09-12','MALE','0123456789','someone@email.com','user12','password','ACTIVE','USER','2024-04-18 09:56:31.3','2024-04-18 09:56:31.3'),
	 ('Dang Dinh','Tuan','1992-10-13','MALE','0123456789','someone@email.com','user13','password','ACTIVE','USER','2024-04-15 21:54:04.258','2024-04-15 21:54:04.258'),
	 ('Nguyen Quoc','Hung','1994-10-14','MALE','0123456789','someone@email.com','user14','password','ACTIVE','USER','2024-04-15 21:57:15.934','2024-04-15 21:57:15.934'),
	 ('Mai Ngoc','Que','1995-11-11','MALE','0123456789','someone@email.com','user15','password','NONE','USER','2024-04-15 22:02:26.532','2024-04-16 21:14:05.098'),
	 ('Tran Tu','Binh','1996-12-15','MALE','0123456789','someone@email.com','user16','password','ACTIVE','USER','2024-04-15 22:05:00.438','2024-04-15 22:05:00.438'),
	 ('Nguyen Hai','Thanh','1997-01-16','FEMALE','0123456789','someone@email.com','user17','password','ACTIVE','USER','2024-04-18 09:56:25.034','2024-04-18 09:56:25.034'),
	 ('Pham Ngoc','Hoa','1998-07-10','FEMALE','0123456789','someone@email.com','user18','password','ACTIVE','USER','2024-04-18 09:56:26.215','2024-04-18 09:56:26.215'),
	 ('Sub','Admin','1981-06-05','MALE','0123456789','admin@email.com','admin','password','ACTIVE','ADMIN','2024-04-18 09:56:24.587','2024-04-18 09:56:24.587'),
	 ('Mai','Manager','1982-07-24','FEMALE','0123456789','someone@email.com','manager','password','ACTIVE','USER','2024-04-18 09:58:07.611','2024-04-18 09:58:07.611'),
	 ('Dinh Van','Nam','1983-06-08','MALE','0123456789','someone@email.com','user1','password','ACTIVE','USER','2024-04-18 09:56:25.435','2024-04-18 09:56:25.435'),
	 ('Pham Quang','Dinh','1984-02-28','MALE','0123456789','someone@email.com','user2','password','ACTIVE','USER','2024-04-18 09:56:25.804','2024-04-18 09:56:25.804'),
	 ('Nguyen Thi Kim','Oanh','1985-01-01','FEMALE','0123456789','someone@email.com','user3','password','ACTIVE','USER','2024-04-18 09:58:08.138','2024-04-18 09:58:08.138'),
	 ('Trinh Van','Sam','1999-01-19','FEMALE','0123456789','someone@email.com','user19','password','ACTIVE','USER','2024-04-18 09:56:26.88','2024-04-18 09:56:26.88'),
	 ('Nguyen Thi','Dung','1986-02-02','MALE','0123456789','someone@email.com','user5','password','ACTIVE','USER','2024-04-18 09:56:26.542','2024-04-18 09:56:26.542'),
	 ('Pham Thi','Chi','1987-03-04','FEMALE','0123456789','someone@email.com','user6','password','ACTIVE','USER','2024-04-18 09:58:08.589','2024-04-18 09:58:08.589'),
	 ('Tran Thuy','Dung','1988-04-05','MALE','0123456789','someone@email.com','user7','password','ACTIVE','USER','2024-04-18 09:56:28.438','2024-04-18 09:56:28.438'),
	 ('Kieu','My','2000-02-22','FEMALE','0123456789','someone@email.com','user10','password','ACTIVE','USER','2024-04-18 09:56:31.622','2024-04-18 09:56:31.622');
